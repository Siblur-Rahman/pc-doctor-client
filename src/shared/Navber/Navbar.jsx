...
const Navbar = () => {
    ...
    const handleToggle = (e) =>{
        ...
        <li><NavLink to="/allservices">All Services</NavLink></li>
        {
            ...
            <div className="dropdown">
                ...
                <div tabIndex={0} role="button" className="btn">Dashboard</div>
    ...
    return (
            ...
            <div className="navbar fixed top-0 z-10 max-w-5xl">
                <div className="navbar-start">
                    ...
                    <NavLink to="/" className="btn btn-ghost text-xl">PC-DOCTOR</NavLink>
                </div>
